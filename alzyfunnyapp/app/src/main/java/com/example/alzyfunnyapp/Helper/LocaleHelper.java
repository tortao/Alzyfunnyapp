package com.example.alzyfunnyapp.Helper;
...
public class LocaleHelper {
    ...
    private static Context updateResourcesLegacy(Context context, String lang) {
        ...
        Configuration confic = resources.getConfiguration();
        confic.locale = locale;
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.P)
            confic.setLayoutDirection(locale);
        resources.updateConfiguration(confic,resources.getDisplayMetrics());
        return context;
    }
