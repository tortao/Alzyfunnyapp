...
import com.memo.match.ui.DifficultyView;

public class DifficultySelectFragment extends Fragment {

    /*
    หน้านี้คือ หน้าที่โชว์ด่านต่าง ๆ กับ โชว์ ตัว บอร์ดของ besttime
     */
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Typeface type = Typeface.createFromAsset(Shared.context.getAssets(), "fonts/DailyMilk.ttf");
